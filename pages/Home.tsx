    ...
    return (
        <div>
            ...
            <section id="main-hero" aria-label="introduction">
                ...
                <div id="hero-right">
                    <img src="src/img/hero-image.webp" alt="Kimberly, a white woman with curly red hair, stands in a forest next to a trailhead sign. She is looking to the left, and she is wearing a green beanie, black rain jacket, black jeans, and a graphic t-shirt." />
            ...
            <section id="about-me" aria-label="About Me">
                ...
                <div id="about-right">
                    ...
                    <div id="trees">
                        <img src="../src/img/tree-fill.svg" alt="taller silhouette of a pine tree" id="tree-1"/><img src="../src/img/tree-fill.svg" alt="shorter silhouette of a pine tree" id="tree-2"/>
                    </div>
                </div>
            </section>
            { /* PROJECTS */ }
            <section id="projects-section" aria-label="My Projects">
                ...
                <div id="project-cards">
                    { /* Cards added in via index.js function */ }
                    <script type="application/javascript" src="../src/js/project-cards.js"></script> 
                </div>
            </section>
            <footer id="footer">
                <div className="icon-bar">
                    <a href="https://github.com/kimboleh"><img src="src/img/icons/github.png" alt="github logo icon" /></a>
                    <a href="mailto:hello@kimberlynachbur.dev"><img src="src/img/icons/email.png" alt="email envelope icon" /></a>
                </div>
